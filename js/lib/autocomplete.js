...
export function attachAutocomplete(input) {
  ...
  input.addEventListener('input', async () => {
    ...
    function select(i){
      ...
      input.dataset.code = it.code;                 // airport OR city code
...
export function attachAutocomplete(input) {
  ...
  input.addEventListener('input', async () => {
    ...
    function select(i){
      const it = items[i];
      input.value = `${it.name} (${it.code})`;
      input.dataset.code = it.code;                 // airport OR city code as shown
      input.dataset.city = it.city_code || it.code; // city code fallback
      menu.hidden = true;
    }
  });
